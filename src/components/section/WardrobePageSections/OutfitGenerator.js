...
export default function OutfitGenerator() {
  ...
  return (
    ...
    <OutfitCardComponent icon={movieIcon} title='Netflix & Chill' description='Let her pick the movie! I gotchu with the fit.' background={movieBackground}/>
    ...
    <OutfitCardComponent icon={celebrationIcon} title='Party' description='Let’s turn up!' background={celebrationBackground}/>
